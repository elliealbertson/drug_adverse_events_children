...
:pill: Drug adverse events are an important preventable cause of morbidity and mortality.:pill:
...
- Used the `requests` module to get JSON data from the [FDA Adverse Event Reporting System](https://open.fda.gov/apis/drug/event/)
